...
In RStudio it is actioned through the File > New Project > Version Control > Git and pasting in the URL from your GitHub or GitLab repository.

Alternatively from the terminal it is something like:  
