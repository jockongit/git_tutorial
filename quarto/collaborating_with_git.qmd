...
## Alternatively, if you already have a project on your computer that you wish to connect to GitLab/GitHub then you need to make sure it is an R project and has git initialised. If you want to connect to HitHub it is very easy, just run **usethis::use_github()** in an r script in the project you want to connect. 
